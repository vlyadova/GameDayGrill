...
window.onscroll = function() {
    ...
    if (window.pageYOffset > headerSection.offsetHeight - 200) {
    ...
    // home page JS
    if (pageTitle.text === "GAME DAY GRILL- Restaurant") {
...
function scrollToBottom() {
  // Get the element with the id "bottom"
